...
function PureDropdown(dropdownParent) {
  ...
  document.addEventListener('keydown', function (e) {
    let currentLink, previousSibling, nextSibling, previousLink, nextLink;
...
// Compared to the initial script I copy pasted,
// I replaced the execution of initDropdowns with an export
// so I can import the function in the controller of the route.
